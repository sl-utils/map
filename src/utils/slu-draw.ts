 ...
 */
function convertgps84Togcj02(map: L.Map | AMAP.Map | MaplibreMap, plot: MapArc | MapLine | MapRect | MapText | MapImage | MapArc[] | MapLine[] | MapRect[] | MapText[] | MapImage[] | (MDataParticle & CanvasPosition)[]): void {
