...
exports.MapPluginTrack = void 0;
const plugin_draw_1 = require("./plugin-draw");
const map_1 = require("../map");
const utils_1 = require("../utils");
class MapPluginTrack {
    constructor(sluMap, options) {
        ...
        this.layerDraw = new plugin_draw_1.MapPluginDraw(sluMap, this.options);
        this.layerAniDraw = new plugin_draw_1.MapPluginDraw(sluMap, Object.assign({}, this.options, { zIndex, className: "track ani" }));
        this.allEvents = new map_1.MapCanvasEvent(map);
    }
    onRemove() {
    ...
    setTracks(tracks) {
        if ((0, utils_1.u_tsMapisAmap)(this.map)) {
            tracks.forEach(track => {
                track.data.forEach(e => {
                    const { lat, lng } = (0, utils_1.u_mapTogps84gcj02)(e.lng, e.lat);
                    e.lat = lat;
                    e.lng = lng;
                });
            });
...
exports.MapPluginTrack = MapPluginTrack;
