...
exports.MapPluginGridRender = void 0;
const map_1 = require("../map");
const slu_worker_1 = require("../utils/slu-worker");
const slu_map_1 = require("../utils/slu-map");
class MapPluginGridRender extends map_1.MapCanvasLayer {
    constructor(sluMap, options, mask) {
        super(sluMap.map, options);
        this.worker = new slu_worker_1.SLUWorker("gridRender", (d) => this.workerCb(d));
        this.workerId = 0;
        this.options = {
            pane: "wavePane",
            zIndex: 200,
    ...
    render() {
        ...
        for (let gy = 0; gy < geoRows; gy++) {
            ...
            for (let gx = 0; gx < geoCols; gx++) {
                ...
                const latlng = (0, slu_map_1.u_mapGetLatLngByPoint)(this.map, [px, py]);
...
exports.MapPluginGridRender = MapPluginGridRender;
