...
exports.MapPluginDraw = void 0;
const map_1 = require("../map");
class MapPluginDraw extends map_1.MapCanvasLayer {
    constructor(sluMap, options) {
        super(sluMap.map, options);
        this._draw = new map_1.MapCanvasDraw(sluMap.map, this.canvas);
    }
    renderFixedData() {
        this.resetCanvas();
        this.drawMapAll();
...
exports.MapPluginDraw = MapPluginDraw;
