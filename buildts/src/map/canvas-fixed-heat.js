...
exports.MapCanvasFixedHeat = void 0;
const slu_map_1 = require("../utils/slu-map");
class MapCanvasFixedHeat {
    ...
    renderToImage() {
        ...
        const projPoints = data.map(d => {
            const [x, y] = (0, slu_map_1.u_mapGetProjectedPointByLatlng)(this.map, d[0], d[1], refZoom);
            return [x, y, d[2]];
        });
    ...
    draw() {
        ...
        if (zoom < minZoom || zoom > maxZoom)
            return;
        const sw = (0, slu_map_1.u_mapGetPointByLatlng)(this.map, [bounds.minLat, bounds.minLng]);
        const ne = (0, slu_map_1.u_mapGetPointByLatlng)(this.map, [bounds.maxLat, bounds.maxLng]);
...
exports.MapCanvasFixedHeat = MapCanvasFixedHeat;
