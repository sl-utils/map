import { __module as Wt } from "../../../_virtual/leaflet-src2.js";
var Go = Wt.exports, _n;
function jo() {
  return _n ? Wt.exports : (_n = 1, (function(qo, mn) {
    (function(l, le) {
      le(mn);
    })(Go, (function(l) {
      var le = "1.9.4";
      ...
      var $e = 0;
      function ti(t) {
        var e = +/* @__PURE__ */ new Date(), i = Math.max(0, 16 - (e - $e));
        return $e = e + i, window.setTimeout(t, i);
      }
      var _e = window.requestAnimationFrame || de("RequestAnimationFrame") || ti, ei = window.cancelAnimationFrame || de("CancelAnimationFrame") || de("CancelRequestAnimationFrame") || function(t) {
      ...
      it.extend = function(t) {
        ...
        return t.statics && b(e, t.statics), t.includes && (gn(t.includes), b.apply(null, [n].concat(t.includes))), b(n, t), delete n.statics, delete n.includes, n.options && (n.options = i.options ? Ut(i.options) : {}, b(n.options, t.options)), n._initHooks = [], n.callInitHooks = function() {
      ...
      var ge = document.documentElement.style, qt = "ActiveXObject" in window, wn = qt && !document.addEventListener, ri = "msLaunchUri" in navigator && !("documentMode" in document), ye = Q("webkit"), ai = Q("android"), hi = Q("android 2") || Q("android 3"), xn = parseInt(/WebKit\/([0-9]+)|$/.exec(navigator.userAgent)[1], 10), Pn = ai && Q("Google") && xn < 537 && !("AudioNode" in window), we = !!window.opera, ui = !ri && Q("chrome"), li = Q("gecko") && !ye && !we && !qt, Ln = !ui && Q("safari"), ci = Q("phantom"), fi = "OTransition" in ge, Tn = navigator.platform.indexOf("Win") === 0, di = qt && "transition" in ge, xe = "WebKitCSSMatrix" in window && "m11" in new window.WebKitCSSMatrix() && !hi, _i = "MozPerspective" in ge, bn = !window.L_DISABLE_3D && (di || xe || _i) && !fi && !ci, zt = typeof orientation < "u" || Q("mobile"), Mn = zt && ye, Cn = zt && xe, mi = !window.PointerEvent && window.MSPointerEvent, pi = !!(window.PointerEvent || mi), vi = "ontouchstart" in window || !!window.TouchEvent, Sn = !window.L_NO_TOUCH && (vi || pi), zn = zt && we, kn = zt && li, En = (window.devicePixelRatio || window.screen.deviceXDPI / window.screen.logicalXDPI) > 1, Zn = (function() {
        var t = !1;
        try {
      ...
      })(), Pe = !!(document.createElementNS && oi("svg").createSVGRect), In = !!Pe && (function() {
      ...
      })(), Bn = navigator.platform.indexOf("Mac") === 0, Nn = navigator.platform.indexOf("Linux") === 0;
      function Q(t) {
      ...
      var f = {
        ...
        mac: Bn,
        linux: Nn
      }, gi = f.msPointer ? "MSPointerDown" : "pointerdown", yi = f.msPointer ? "MSPointerMove" : "pointermove", wi = f.msPointer ? "MSPointerUp" : "pointerup", xi = f.msPointer ? "MSPointerCancel" : "pointercancel", Le = {
        touchstart: gi,
        touchmove: yi,
        touchend: wi,
        touchcancel: xi
      ...
      function Rn(t, e, i) {
        return e === "touchstart" && Wn(), Pi[e] ? (i = Pi[e].bind(this, i), t.addEventListener(Le[e], i, !1), i) : (console.warn("wrong event specified:", e), E);
      }
      function Dn(t, e, i) {
        if (!Le[e]) {
      ...
      function Wn() {
        Li || (document.addEventListener(gi, Hn, !0), document.addEventListener(yi, Fn, !0), document.addEventListener(wi, Ti, !0), document.addEventListener(xi, Ti, !0), Li = !0);
      }
      function Vt(t, e) {
      ...
      function Z(t, e) {
        t.classList !== void 0 ? t.classList.remove(e) : Me(t, ce((" " + Kt(t) + " ").replace(" " + e + " ", " ")));
      }
      function Me(t, e) {
      ...
      function ft(t, e, i) {
        var n = e || new m(0, 0);
        t.style[Te] = (f.ie3d ? "translate(" + n.x + "px," + n.y + "px)" : "translate3d(" + n.x + "px," + n.y + "px,0)") + (i ? " scale(" + i + ")" : "");
      }
      function I(t, e) {
      ...
      if ("onselectstart" in document)
        ...
        Zt = function() {
          ...
          It && (document.documentElement.style[It] = Ce, Ce = void 0);
        };
      }
      function Se() {
      ...
      function Ee(t) {
        for (; t.tabIndex === -1; )
          t = t.parentNode;
        t.style && (Jt(), Xt = t, ke = t.style.outlineStyle, t.style.outlineStyle = "none", p(window, "keydown", Jt));
      }
      function Jt() {
        Xt && (Xt.style.outlineStyle = ke, Xt = void 0, ke = void 0, M(window, "keydown", Jt));
      }
      function Ci(t) {
        do
          t = t.parentNode;
      ...
      function Ie(t, e, i, n) {
        ...
        !f.touchNative && f.pointer && e.indexOf("touch") === 0 ? s = Rn(t, e, s) : f.touch && e === "dblclick" ? s = Vn(t, s) : "addEventListener" in t ? e === "touchstart" || e === "touchmove" || e === "wheel" || e === "mousewheel" ? t.addEventListener(Oe[e] || e, s, f.passiveEvents ? { passive: !1 } : !1) : e === "mouseenter" || e === "mouseleave" ? (s = function(a) {
          a = a || window.event, Ne(t, a) && r(a);
        }, t.addEventListener(Oe[e], s, !1)) : t.addEventListener(e, r, !1) : t.attachEvent("on" + e, s), t[$] = t[$] || {}, t[$][o] = s;
      }
      function Ae(t, e, i, n, o) {
        ...
        if (!s)
          return this;
        !f.touchNative && f.pointer && e.indexOf("touch") === 0 ? Dn(t, e, s) : f.touch && e === "dblclick" ? jn(t, s) : "removeEventListener" in t ? t.removeEventListener(Oe[e] || e, s, !1) : t.detachEvent("on" + e, s), t[$][o] = null;
      }
      function _t(t) {
        return t.stopPropagation ? t.stopPropagation() : t.originalEvent ? t.originalEvent._stopped = !0 : t.cancelBubble = !0, this;
      }
      function Be(t) {
        return Ie(t, "wheel", _t), this;
      }
      function At(t) {
      ...
      var Xn = f.linux && f.chrome ? window.devicePixelRatio : f.mac ? window.devicePixelRatio * 3 : window.devicePixelRatio > 0 ? 2 * window.devicePixelRatio : 1;
      function Ei(t) {
        return f.edge ? t.wheelDeltaY / 2 : (
          // Don't trust window-geometry-based delta
          t.deltaY && t.deltaMode === 0 ? -t.deltaY / Xn : (
            // Pixels
      ...
      var Jn = {
        ...
        panBy: function(t, e) {
          ...
          if (this._panAnim || (this._panAnim = new Zi(), this._panAnim.on({
        ...
        flyTo: function(t, e, i) {
          ...
          function g(A) {
            var ue = A ? -1 : 1, Ho = A ? h : a, Fo = h * h - a * a + ue * d * d * u * u, Wo = 2 * Ho * d * u, Ke = Fo / Wo, dn = Math.sqrt(Ke * Ke + 1) - Ke, Uo = dn < 1e-9 ? -18 : Math.log(dn);
            return Uo;
          }
          function R(A) {
          ...
          var Ro = Date.now(), cn = (g(1) - W) / c, Do = i.duration ? 1e3 * i.duration : 1e3 * cn * 0.8;
          function fn() {
            var A = (Date.now() - Ro) / Do, ue = No(A) * cn;
            A <= 1 ? (this._flyToFrame = D(fn, this), this._move(
              this.unproject(n.add(o.subtract(n).multiplyBy(Bo(ue) / u)), r),
              this.getScaleZoom(a / bt(ue), r),
              { flyTo: !0 }
        ...
        _fireDOMEvent: function(t, e, i) {
          ...
          if (o.length) {
            ...
            for (r = 0; r < o.length; r++)
              if (o[r].fire(e, h, !0), h.originalEvent._stopped || o[r].options.bubblingMouseEvents === !1 && fe(this._mouseEvents, e) !== -1)
                return;
          }
        },
        ...
        _createAnimProxy: function() {
          ...
          this._panes.mapPane.appendChild(t), this.on("zoomanim", function(e) {
            var i = Te, n = this._proxy.style[i];
      ...
      var Oi = Y.extend({
        ...
        _initLayout: function() {
          ...
          e.setAttribute("aria-haspopup", !0), At(e), Be(e);
        ...
        _createButton: function(t, e, i, n, o) {
          var s = P("a", i, n);
          return s.innerHTML = t, s.href = "#", s.title = e, s.setAttribute("role", "button"), s.setAttribute("aria-label", e), At(s), p(s, "click", mt), p(s, "click", o, this), p(s, "click", this._refocusOnMap, this), s;
        },
      ...
      var to = function(t) {
        ...
        return new Ii(t);
      }, io = '<svg aria-hidden="true" xmlns="http://www.w3.org/2000/svg" width="12" height="8" viewBox="0 0 12 8" class="leaflet-attribution-flag"><path fill="#4C7BE1" d="M0 0h12v4H0z"/><path fill="#FFD500" d="M0 4h12v3H0z"/><path fill="#E0BC00" d="M0 7h12v1H0z"/></svg>', De = Y.extend({
        // @section
        ...
        options: {
          ...
          prefix: '<a href="https://leafletjs.com" title="A JavaScript library for interactive maps">' + (f.inlineSvg ? io + " " : "") + "Leaflet</a>"
        },
        initialize: function(t) {
          S(this, t), this._attributions = {};
        },
        onAdd: function(t) {
          t.attributionControl = this, this._container = P("div", "leaflet-control-attribution"), At(this._container);
      ...
      Y.Layers = Oi, Y.Zoom = Re, Y.Scale = Ii, Y.Attribution = De, Bt.layers = $n, Bt.zoom = to, Bt.scale = eo, Bt.attribution = no;
      var tt = it.extend({
        initialize: function(t) {
          this._map = t;
        },
      ...
      var oo = { Events: U }, Ai = f.touch ? "touchstart mousedown" : "mousedown", ut = Ct.extend({
        options: {
          // @section
        ...
        disable: function() {
          this._enabled && (ut._dragging === this && this.finishDrag(!0), M(this._dragStartTarget, Ai, this._onDown, this), this._enabled = !1, this._moved = !1);
        },
        _onDown: function(t) {
          if (this._enabled && (this._moved = !1, !be(this._element, "leaflet-zoom-anim"))) {
            ...
            if (!(ut._dragging || t.shiftKey || t.which !== 1 && t.button !== 1 && !t.touches) && (ut._dragging = this, this._preventOutline && Ee(this._element), Se(), Zt(), !this._moving)) {
              this.fire("down");
        ...
        finishDrag: function(t) {
          Z(document.body, "leaflet-dragging"), this._lastTarget && (Z(this._lastTarget, "leaflet-drag-target"), this._lastTarget = null), M(document, "mousemove touchmove", this._onMove, this), M(document, "mouseup touchend touchcancel", this._onUp, this), ze(), Ot();
      ...
      function Bi(t, e, i) {
        ...
        for (a = 0; a < 4; a++) {
          for (d = o[a], n = [], s = 0, c = t.length, r = c - 1; s < c; r = s++)
            h = t[s], u = t[r], h._code & d ? u._code & d || (g = Qt(u, h, d, e, i), g._code = pt(g, e), n.push(g)) : (u._code & d && (g = Qt(u, h, d, e, i), g._code = pt(g, e), n.push(g)), n.push(h));
          t = n;
        }
        return t;
      }
      ...
      function Fi(t, e, i, n, o) {
        ...
        for (Hi = r; ; ) {
          ...
          if (s & r)
            return !1;
          a = s || r, h = Qt(t, e, a, i, o), u = pt(h, i), a === s ? (t = h, s = u) : (e = h, r = u);
        }
      }
      ...
      nt.Earth = ht, nt.EPSG3395 = fo, nt.EPSG3857 = ve, nt.EPSG900913 = yn, nt.EPSG4326 = Gi, nt.Simple = _o;
      var X = Ct.extend({
      ...
      var Rt = xt.extend({
        ...
        _getIconUrl: function(t) {
          return typeof Rt.imagePath != "string" && (Rt.imagePath = this._detectIconPath()), (this.options.imagePath || Rt.imagePath) + xt.prototype._getIconUrl.call(this, t);
        },
        ...
        _detectIconPath: function() {
          var t = P("div", "leaflet-default-icon-path", document.body), e = Et(t, "background-image") || Et(t, "backgroundImage");
      ...
      var Ge = te.extend({
        initialize: function(t, e, i) {
          if (typeof e == "number" && (e = b({}, i, { radius: e })), S(this, e), this._latlng = y(t), isNaN(this.options.radius))
      ...
      var st = lt.extend({
        ...
        _convertLatLngs: function(t) {
          for (var e = [], i = V(t), n = 0, o = t.length; n < o; n++)
      ...
      function ee(t, e) {
        ...
        switch (i.type) {
          case "Point":
            return a = r(n), Vi(s, t, a, e);
          case "MultiPoint":
            for (u = 0, c = n.length; u < c; u++)
              a = r(n[u]), o.push(Vi(s, t, a, e));
            return new ot(o);
          case "LineString":
          case "MultiLineString":
            return h = ie(n, i.type === "LineString" ? 0 : 1, r), new st(h, e);
          case "Polygon":
          case "MultiPolygon":
            return h = ie(n, i.type === "Polygon" ? 1 : 2, r), new Pt(h, e);
      ...
      function ie(t, e, i) {
        for (var n = [], o = 0, s = t.length, r; o < s; o++)
          r = e ? ie(t[o], e - 1, i) : (i || qe)(t[o]), n.push(r);
        return n;
      }
      function Ve(t, e) {
      ...
      function ne(t, e, i, n) {
        for (var o = [], s = 0, r = t.length; s < r; s++)
          o.push(e ? ne(t[s], V(t[s]) ? 0 : e - 1, i, n) : Ve(t[s], n));
        return !e && i && o.length > 0 && o.push(o[0].slice()), o;
      }
      function Lt(t, e) {
        return t.feature ? b({}, t.feature, { geometry: e }) : oe(e);
      }
      function oe(t) {
      ...
      $t.include(je), Ge.include(je), te.include(je), st.include({
        toGeoJSON: function(t) {
          var e = !V(this._latlngs), i = ne(this._latlngs, e ? 1 : 0, !1, t);
          return Lt(this, {
        ...
        toGeoJSON: function(t) {
          var e = !V(this._latlngs), i = e && !V(this._latlngs[0]), n = ne(this._latlngs, i ? 2 : e ? 1 : 0, !0, t);
      ...
      var Lo = ji, se = X.extend({
        ...
        _initImage: function() {
          ...
          if (v(e, "leaflet-image-layer"), this._zoomAnimated && v(e, "leaflet-zoom-animated"), this.options.className && v(e, this.options.className), e.onselectstart = E, e.onmousemove = E, e.onload = C(this.fire, this, "load"), e.onerror = C(this._overlayOnError, this, "error"), (this.options.crossOrigin || this.options.crossOrigin === "") && (e.crossOrigin = this.options.crossOrigin === !0 ? "" : this.options.crossOrigin), this.options.zIndex && this._updateZIndex(), t) {
            this._url = e.src;
            return;
          }
        ...
        _initImage: function() {
          ...
          if (v(e, "leaflet-image-layer"), this._zoomAnimated && v(e, "leaflet-zoom-animated"), this.options.className && v(e, this.options.className), e.onselectstart = E, e.onmousemove = E, e.onloadeddata = C(this.fire, this, "load"), t) {
      ...
      var et = X.extend({
        ...
        initialize: function(t, e) {
          t && (t instanceof T || K(t)) ? (this._latlng = y(t), S(this, e)) : (S(this, t), this._source = e), this.options.content && (this._content = this.options.content);
        },
      ...
      var re = et.extend({
        ...
        _initLayout: function() {
          ...
          if (this._contentNode = P("div", t + "-content", i), At(e), Be(this._contentNode), p(e, "contextmenu", _t), this._tipContainer = P("div", t + "-tip-container", e), this._tip = P("div", t + "-tip", this._tipContainer), this.options.closeButton) {
        ...
        _adjustPan: function() {
          if (this.options.autoPan) {
            ...
            var t = this._map, e = parseInt(Et(this._container, "marginBottom"), 10) || 0, i = this._container.offsetHeight + e, n = this._containerWidth, o = new m(this._containerLeft, -i - this._containerBottom);
      ...
      var Dt = X.extend({
        ...
        getEvents: function() {
          ...
          return this.options.updateWhenIdle || (this._onMove || (this._onMove = Xe(this._onMoveEnd, this.options.updateInterval, this)), t.move = this._onMove), this._zoomAnimated && (t.zoomanim = this._animateZoom), t;
        },
        // @section Extension methods
        ...
        _addTile: function(t, e) {
          ...
          this._initTile(o), this.createTile.length < 2 && D(C(this._tileReady, this, t, null, o)), I(o, i), this._tiles[n] = {
            el: o,
            coords: t,
            current: !0
        ...
        _tileReady: function(t, e, i) {
          ...
          i = this._tiles[n], i && (i.loaded = +/* @__PURE__ */ new Date(), this._map._fadeAnimated ? (q(i.el, 0), G(this._fadeFrame), this._fadeFrame = D(this._updateOpacity, this)) : (i.active = !0, this._pruneTiles()), e || (v(i.el, "leaflet-tile-loaded"), this.fire("tileload", {
            tile: i.el,
            coords: t
      ...
      var Tt = Dt.extend({
        ...
        _removeTile: function(t) {
          var e = this._tiles[t];
          if (e)
            return e.el.setAttribute("src", Gt), Dt.prototype._removeTile.call(this, t);
        },
        _tileReady: function(t, e, i) {
      ...
      var Qi = Tt.extend({
        ...
        getTileUrl: function(t) {
          var e = this._tileCoordsToNwSe(t), i = this._crs, n = H(i.project(e[0]), i.project(e[1])), o = n.min, s = n.max, r = (this._wmsVersion >= 1.3 && this._crs === Gi ? [o.y, o.x, s.y, s.x] : [o.x, o.y, s.x, s.y]).join(","), a = Tt.prototype.getTileUrl.call(this, t);
          return a + Je(this.wmsParams, a, this.options.uppercase) + (this.options.uppercase ? "&BBOX=" : "&bbox=") + r;
        },
      ...
      Ft.create = he, Ft.pointsToPath = si, rt.geometryToLayer = ee, rt.coordsToLatLng = qe, rt.coordsToLatLngs = ie, rt.latLngToCoords = Ve, rt.latLngsToCoords = ne, rt.getFeature = Lt, rt.asFeature = oe, w.mergeOptions({
      ...
      var on = tt.extend({
        ...
        _onMouseDown: function(t) {
          if (!t.shiftKey || t.which !== 1 && t.button !== 1)
            return !1;
          this._clearDeferredResetState(), this._resetState(), Zt(), Se(), this._startPoint = this._map.mouseEventToContainerPoint(t), p(document, {
            contextmenu: mt,
        ...
        _finish: function() {
          this._moved && (k(this._box), Z(this._container, "leaflet-crosshair")), Ot(), ze(), M(document, {
            contextmenu: mt,
            mousemove: this._onMouseMove,
            mouseup: this._onMouseUp,
            keydown: this._onKeyDown
      ...
      w.addInitHook("addHandler", "boxZoom", on), w.mergeOptions({
      ...
      var hn = tt.extend({
        ...
        _onWheelScroll: function(t) {
          var e = Ei(t), i = this._map.options.wheelDebounceTime;
      ...
      var un = tt.extend({
        ...
        _onDown: function(t) {
          if (clearTimeout(this._holdTimeout), t.touches.length === 1) {
            ...
            }, this), Io), p(document, "touchend touchcancel contextmenu", this._cancel, this), p(document, "touchmove", this._onMove, this);
          }
        },
      ...
      w.addInitHook("addHandler", "touchZoom", ln), w.BoxZoom = on, w.DoubleClickZoom = sn, w.Drag = rn, w.Keyboard = an, w.ScrollWheelZoom = hn, w.TapHold = un, w.TouchZoom = ln, l.Bounds = z, l.Browser = f, l.CRS = nt, l.Canvas = $i, l.Circle = Ge, l.CircleMarker = te, l.Class = it, l.Control = Y, l.DivIcon = Xi, l.DivOverlay = et, l.DomEvent = Jn, l.DomUtil = Yn, l.Draggable = ut, l.Evented = Ct, l.FeatureGroup = ot, l.GeoJSON = rt, l.GridLayer = Dt, l.Handler = tt, l.Icon = xt, l.ImageOverlay = se, l.LatLng = T, l.LatLngBounds = F, l.Layer = X, l.LayerGroup = wt, l.LineUtil = lo, l.Map = w, l.Marker = $t, l.Mixin = oo, l.Path = lt, l.Point = m, l.PolyUtil = so, l.Polygon = Pt, l.Polyline = st, l.Popup = re, l.PosAnimation = Zi, l.Projection = co, l.Rectangle = nn, l.Renderer = at, l.SVG = Ft, l.SVGOverlay = Yi, l.TileLayer = Tt, l.Tooltip = ae, l.Transformation = pe, l.Util = vn, l.VideoOverlay = Ki, l.bind = C, l.bounds = H, l.canvas = tn, l.circle = wo, l.circleMarker = yo, l.control = Bt, l.divIcon = zo, l.extend = b, l.featureGroup = po, l.geoJSON = ji, l.geoJson = Lo, l.gridLayer = ko, l.icon = vo, l.imageOverlay = To, l.latLng = y, l.latLngBounds = O, l.layerGroup = mo, l.map = Qn, l.marker = go, l.point = _, l.polygon = Po, l.polyline = xo, l.popup = Co, l.rectangle = Oo, l.setOptions = S, l.stamp = x, l.svg = en, l.svgOverlay = Mo, l.tileLayer = Ji, l.tooltip = So, l.transformation = St, l.version = le, l.videoOverlay = bo;
      var Ao = window.L;
